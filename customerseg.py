...
df = pd.read_excel("C:/Users/zinci/Downloads/online_retail_II-230817-120704.xlsx")
df.head()
...
# scaler
# daha eşit bir şekilde değerlendirebilmesi(requency, frequency arasında) için scaler yapılır.
